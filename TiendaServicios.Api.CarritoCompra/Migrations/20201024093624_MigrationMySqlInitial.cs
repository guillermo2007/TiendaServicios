    ...
    public partial class MigrationMySqlInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarritosSesiones", x => x.CarritoSesionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarritoSesionDetalles_CarritosSesiones_CarritoSesionId",
                        column: x => x.CarritoSesionId,
                        principalTable: "CarritosSesiones",
